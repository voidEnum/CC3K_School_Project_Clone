...
// RH implementation
Potion_RH::Potion_RH(int p): potency{p} {}
...
// PH implementation
Potion_PH::Potion_PH(int p): potency{p} {}
...
Potion_BA::Potion_BA(int p): potency{p} {}
...
Potion_WA::Potion_WA(int p): potency{p} {}
...
Potion_BD::Potion_BD(int p): potency{p} {}
...
// WA implementation incomplete
Potion_WD::Potion_WD(int p): potency{p} {}
